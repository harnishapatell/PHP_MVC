...
<?php } ?>
                ...
                ?>
                        ...
                        <tbody>
                                        ...
                                        <td><img src="<?php echo $row['image']; ?>" height="75" width="100"></td>
                                        <td><?php echo htmlentities($row['datetime']);?></td>
                                        <td><a href="?stid=<?php echo $row["id"];?>&status=<?php echo $row["status"];?>"><?php echo $row["status"];?></td>
                                        <td><a href="update.php?id=<?php echo base64_encode($row['id']);?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil">Edit</span></a></td>
                                        <td><a href="index.php?delCat=<?php echo base64_encode($row['id']);?>" class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete');"><span class="glyphicon glyphicon-trash">Delete</span></a></td>
